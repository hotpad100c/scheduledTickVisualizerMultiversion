...
public record HelloPacketPayload() implements CustomPayload {
    public static final CustomPayload.Id<HelloPacketPayload> ID = new CustomPayload.Id<>(ScheduledTickVisualizer.HELLO_PACKET_ID);
    public static final PacketCodec<PacketByteBuf, HelloPacketPayload> CODEC = PacketCodec.of(
            (value, buf) -> {
